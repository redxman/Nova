    ...
    public class FilesHelper
    {
        ...
        public void UploadAndShowResults(HttpContext ContentBase, List<ViewDataUploadFilesResult> resultList)
        {
            ...
            foreach (IFormFile file in httpRequest.Form.Files)
            {
                ...
                //var file = httpRequest.Form.Files[inputTagName];
                ...
                else
                {
                    ...
                    //loadPartialFile(headers["X-File-Name"], ContentBase, resultList);
                }
            }
        }
            ...
            //for (int i = 0; i < request.Files.Count; i++)
            {
                ...
                if (imageArray.Length != 0)
                {
                    ...
                    else
                    {
                        ...
                        {
                            MagicImageProcessor.ProcessImage(fullPath, outStream, new ProcessImageSettings { Width = 80 });
                        }
